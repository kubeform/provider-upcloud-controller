...
// +kubebuilder:rbac:groups=object.upcloud.kubeform.com,resources=storages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=object.upcloud.kubeform.com,resources=storages/status,verbs=get;update;patch
