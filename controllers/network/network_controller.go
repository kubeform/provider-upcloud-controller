...
// +kubebuilder:rbac:groups=network.upcloud.kubeform.com,resources=networks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.upcloud.kubeform.com,resources=networks/status,verbs=get;update;patch
