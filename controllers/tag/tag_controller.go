...
// +kubebuilder:rbac:groups=tag.upcloud.kubeform.com,resources=tags,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=tag.upcloud.kubeform.com,resources=tags/status,verbs=get;update;patch
