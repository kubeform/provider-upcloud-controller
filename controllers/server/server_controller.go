...
// +kubebuilder:rbac:groups=server.upcloud.kubeform.com,resources=servers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=server.upcloud.kubeform.com,resources=servers/status,verbs=get;update;patch
