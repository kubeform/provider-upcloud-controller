...
// +kubebuilder:rbac:groups=router.upcloud.kubeform.com,resources=routers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=router.upcloud.kubeform.com,resources=routers/status,verbs=get;update;patch
...
func (r *RouterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &routerv1alpha1.Router{}); err != nil {
			klog.Error(err, "unable to set up auditor", routerv1alpha1.Router{}.APIVersion, routerv1alpha1.Router{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&routerv1alpha1.Router{}).
