...
// +kubebuilder:rbac:groups=storage.upcloud.kubeform.com,resources=storages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.upcloud.kubeform.com,resources=storages/status,verbs=get;update;patch
...
func (r *StorageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.Storage{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.Storage{}.APIVersion, storagev1alpha1.Storage{}.Kind)
			return err
		}
	}
