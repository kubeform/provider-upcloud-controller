module kubeform.dev/provider-upcloud-controller

go 1.17

require (
	github.com/UpCloudLtd/terraform-provider-upcloud v0.0.0-20220214092419-2a68e4ca5b46
	...
	kubeform.dev/provider-upcloud-api v0.4.1-0.20220308121236-f571f41a14dd
...
require (
	...
	github.com/UpCloudLtd/upcloud-go-api/v4 v4.1.3 // indirect
