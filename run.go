...
import (
	...
	upcloudscheme "kubeform.dev/provider-upcloud-api/client/clientset/versioned/scheme"
...
func init() {
	_ = upcloudscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform upcloud Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-upcloud-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "upcloud.kubeform.com",
			})
			if err != nil {
